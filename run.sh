#!/bin/sh
cat <<-EOF > /root/artalk/artalk-go.yml
# HTTP Server
host: "0.0.0.0"
...
# 数据库
db:
  type: "pgsql" # 支持 sqlite, mysql, pgsql, mssql
...
/root/artalk/artalk-go serve -c /root/artalk/artalk-go.yml
